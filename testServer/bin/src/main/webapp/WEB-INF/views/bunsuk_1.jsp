...
<html xmlns="http://www.w3.org/1999/xhtml" lang="ko" xml:lang="ko"><head>
        ...
        <div id="wrapper">
            ...
            <div id="header">
                <div id="header_content">
                    <h1 class="logo"><a href="index.php"><img src="로고파일 이름 입력" alt="경희대학교 생체의공학과"></a></h1>
                    <div class="top_menu">
                        <ul>
               ...
               <!-- gnb//S-->
                ...
                <script type="text/javascript">
                    jQuery(document).ready(function(){
                        jQuery('#gnb').gnb({ d1: 05, d2: 1 });
                    });
                </script>
            </div>
            <div id="subvisual">
        <img src="images/bigdata_subvisual.png" alt="">
    </div>
    ...
    <div id="asid">
        ...
        <ul class="left_lst">
            <li><a href="index.php?hCode=BOARD&amp;bo_idx=1" style="color:#7d0101; font-weight:600; background:url(/images/menu/menu_on.gif) 0 0 no-repeat;">소식 및 행사</a></li>
    ...
    <div id="content">
        <div class="path">Home &nbsp;&gt;&nbsp; 게시판 &nbsp;&gt;&nbsp; 안녕하세요~~~~~~분석1입니다~~~~~~</div>
            <div class="sub_title">
                <h2>분석 1~~~~~~~~~~~~~~~</h2>
            </div>
            <div class="con_area">	<!--MODULE//S-->

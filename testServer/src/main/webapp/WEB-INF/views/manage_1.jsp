...
<div id="content">
    ...
    <!-- con_area 202006259JH//S-->
	<div class="con_area">
		<class table width="100%" cellpadding=0 cellspacing=0 >
		<td valign=top colspan=2>
		<div class="title">공지<br><div class="txt">
					...
					<table>
						<thead>
							<tr>
								...
								<th width=100 style="background-color:#97A7FF; text-align: center; color: #e8ecff;">번호</th>
								<th style="background-color:#97A7FF; text-align: center;  color: #e8ecff;">제목</th>
								<th width=100 style="background-color: #97A7FF; text-align: center;  color: #e8ecff;">작성자</th>
								<th width=166 style="background-color: #97A7FF; text-align: center;  color: #e8ecff;">작성일</th>
						...
						<tfoot>
							...
							<tr>
								<td colspan="4" style="text-align: center;">
									...
									<strong class="sel_page_num" style="color:#4b5380;">1</strong> 

...
<div id="asid">
	...
	<ul class="left_lst">
		...
		<li><a href="manage_1">공지</a></li>
		<li><a href="manage_2" style='color:#281555; font-weight:600; background:url(img/menu_on.gif) 0 0 no-repeat;'>건의</a></li>
        <li><a href="manage_3">질문</a></li>
        <li><a href="manage_4">문의 Q&amp;A</a></li>
	</ul>
</div><!-- content //S-->
<div id="content">
	<div class="path">Home &nbsp;&gt;&nbsp; 운영 사항 &nbsp;&gt;&nbsp; 건의</div>
	<div class="sub_title">
		<h2>건의</h2>
	</div>
	...
	<div class="con_area">
				...
				<div class="title">건의<br><div class="txt">건의사항 게시판 위치<br>

...
<div id="asid">
	...
	<ul class="left_lst">
		...
		<li><a href="haksoup_1">프로젝트 소개</a></li>
		<li><a href="haksoup_2">코드 공유</a></li>
		<li><a href="haksoup_3" style='color:#281555; font-weight:600; background:url(img/menu_on.gif) 0 0 no-repeat;'>페이지 및 자료 공유</a></li>
		<li><a href="haksoup_4">캐글 분석</a></li>
	</ul>
</div><!-- content //S-->
<div id="content">
	<div class="path">Home &nbsp;&gt;&nbsp; 학습 및 노하우 &nbsp;&gt;&nbsp; 페이지 및 자료 공유</div>
	<div class="sub_title">
		<h2>페이지 및 자료 공유</h2>
	</div>
	...
	<div class="con_area">
				...
				<div class="title"> 이곳에 내용을 입력하세요. <br><div class="txt">이곳에 내용을 입력하세요. <br></div><div class="name">  <p><span style="font-size: 14pt;"><strong>이곳에 내용을 입력하세요.</strong></span></p>
                </div>
                </div>
                </td>
                </table>

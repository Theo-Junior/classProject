...
<div id="asid">
	...
	<ul class="left_lst">
		...
		<li><a href="haksoup_1" style='color:#281555; font-weight:600; background:url(img/menu_on.gif) 0 0 no-repeat;'>프로젝트 소개</a></li>
		<li><a href="haksoup_2">코드 공유</a></li>
		<li><a href="haksoup_3">페이지 및 자료 공유</a></li>
		<li><a href="haksoup_4">캐글 분석</a></li>
	</ul>
...
<div id="content">
	<div class="path">Home &nbsp;&gt;&nbsp; 학습 및 노하우 &nbsp;&gt;&nbsp; 프로젝트 소개</div>
	<div class="sub_title">
		<h2>프로젝트 소개</h2>
	</div>

...
<div id="asid">
	...
	<ul class="left_lst">
		...
		<li><a href="sogae_1">클래스소개</a></li>
		<li><a href="sogae_2">교수님소개</a></li>
		<li><a href="sogae_3"style='color:#7d0101; font-weight:600; background:url(/images/menu/menu_on.gif) 0 0 no-repeat;'>센터소개</a></li>
		<li><a href="sogae_4">기수 연혁</a></li>
		<li><a href="sogae_5">프로젝트 소개</a></li>
	</ul>
</div><!-- content //S-->
<div id="content">
	...
	<div class="sub_title">
		<h2>연혁</h2>
		<table>여기가 연혁 내용 들어가야 합니다.</table>
	</div>
	...
	<div class="con_area">
			...
			<input type="hidden" name="returnUrl" value="index.php?hCode=INTRODUCTION_01_03" />
